...
#ifndef __DHAVN_MOSTMANAGER_DMBTUNERFBLOCK_H_
#define __DHAVN_MOSTMANAGER_DMBTUNERFBLOCK_H_
...
class CVersion
{
	CDMBTuner *m_pInstance;
public:
	explicit CVersion( CDMBTuner *pInstance );
	~CVersion(void);
...
class CFBlockInfo
{
	CDMBTuner *m_pInstance;
public:
	explicit CFBlockInfo( CDMBTuner *pInstance );
	~CFBlockInfo(void);
...
bool FunctionMaturityValue( acs::generated::fblock::DMBTuner::CFBlockInfo::TFunctionMaturity value );
acs::generated::fblock::DMBTuner::CFBlockInfo::TFunctionMaturity FunctionMaturityValue() const;
...
class CSignalQuality
{
	CDMBTuner *m_pInstance;
public:
	explicit CSignalQuality( CDMBTuner *pInstance );
	~CSignalQuality(void);
	...
	bool DMBSignalQualityValue( uint8_t value );
uint8_t DMBSignalQualityValue() const;
::k2l::acs::protocols::most::CMOSTUnsignedByte& DMBSignalQualityDataType();
bool UpdateShadows();
bool Error( ::k2l::acs::protocols::most::DeviceID_t targetDevice, uint32_t payloadLength, const uint8_t *payload );
bool Error( ::k2l::acs::protocols::most::DeviceID_t targetDevice, uint8_t errorCode, uint32_t errorInfoLength, const uint8_t *pErrorInfo );            
...
class CTPEGStatus
{
	CDMBTuner *m_pInstance;
public:
	explicit CTPEGStatus( CDMBTuner *pInstance );
	~CTPEGStatus(void);
	...
	enum TTPEGStatus
{
	TPEGStatusNotReceived = 0,
	TPEGStatusReceiving = 1,
	TPEGStatusNewData = 2,
};
bool TPEGStatusValue( acs::generated::fblock::DMBTuner::CTPEGStatus::TTPEGStatus value );
acs::generated::fblock::DMBTuner::CTPEGStatus::TTPEGStatus TPEGStatusValue() const;
::k2l::acs::protocols::most::CMOSTEnum& TPEGStatusDataType();
bool UpdateShadows();
bool Error( ::k2l::acs::protocols::most::DeviceID_t targetDevice, uint32_t payloadLength, const uint8_t *payload );
bool Error( ::k2l::acs::protocols::most::DeviceID_t targetDevice, uint8_t errorCode, uint32_t errorInfoLength, const uint8_t *pErrorInfo );            
...
class CTPEGInfo
{
	CDMBTuner *m_pInstance;
public:
	explicit CTPEGInfo( CDMBTuner *pInstance );
	~CTPEGInfo(void);
	...
	::k2l::acs::protocols::most::CMOSTFunctionClassSequenceProperty& FunctionInstance(void);
	bool RecevieDateValue( uint8_t * value, uint32_t length );
uint8_t * RecevieDateValue() const;
::k2l::acs::protocols::most::CMOSTString& RecevieDateDataType();
uint32_t RecevieDateLength() const;
bool RecevieDateAddEncoding(uint8_t mostStringIdentifier, const k2l::acs::protocols::most::string::IStringEncoding* pStringEncoding );
bool RecevieDateString(const k2l::acs::protocols::most::string::IStringEncoding* pStringEncoding, const uint8_t* pStringContent, uint32_t stringLengthBytes );
bool RecevieDateString(const k2l::acs::protocols::most::string::IStringEncoding** ppStringEncoding, uint8_t** ppString, uint32_t* pStringLength );
bool RecevieTimeValue( uint8_t * value, uint32_t length );
uint8_t * RecevieTimeValue() const;
::k2l::acs::protocols::most::CMOSTString& RecevieTimeDataType();
uint32_t RecevieTimeLength() const;
bool RecevieTimeAddEncoding(uint8_t mostStringIdentifier, const k2l::acs::protocols::most::string::IStringEncoding* pStringEncoding );
bool RecevieTimeString(const k2l::acs::protocols::most::string::IStringEncoding* pStringEncoding, const uint8_t* pStringContent, uint32_t stringLengthBytes );
bool RecevieTimeString(const k2l::acs::protocols::most::string::IStringEncoding** ppStringEncoding, uint8_t** ppString, uint32_t* pStringLength );
bool RecevieTextValue( uint8_t * value, uint32_t length );
uint8_t * RecevieTextValue() const;
::k2l::acs::protocols::most::CMOSTString& RecevieTextDataType();
uint32_t RecevieTextLength() const;
bool RecevieTextAddEncoding(uint8_t mostStringIdentifier, const k2l::acs::protocols::most::string::IStringEncoding* pStringEncoding );
bool RecevieTextString(const k2l::acs::protocols::most::string::IStringEncoding* pStringEncoding, const uint8_t* pStringContent, uint32_t stringLengthBytes );
bool RecevieTextString(const k2l::acs::protocols::most::string::IStringEncoding** ppStringEncoding, uint8_t** ppString, uint32_t* pStringLength );
bool TPEGInfoValue( uint8_t * value, uint32_t length );
const uint8_t * TPEGInfoValue() const;
::k2l::acs::protocols::most::CMOSTList& TPEGInfoDataType();
uint32_t TPEGInfoStreamLength() const;
bool TPEGInfoLoadNext();
bool TPEGInfoSaveNext();
bool UpdateShadows();
bool Error( ::k2l::acs::protocols::most::DeviceID_t targetDevice, uint32_t payloadLength, const uint8_t *payload );
bool Error( ::k2l::acs::protocols::most::DeviceID_t targetDevice, uint8_t errorCode, uint32_t errorInfoLength, const uint8_t *pErrorInfo );            
...
class CDMBStatus
{
	CDMBTuner *m_pInstance;
public:
	explicit CDMBStatus( CDMBTuner *pInstance );
	~CDMBStatus(void);
...
bool DMBStatusValue( acs::generated::fblock::DMBTuner::CDMBStatus::TDMBStatus value );
acs::generated::fblock::DMBTuner::CDMBStatus::TDMBStatus DMBStatusValue() const;
::k2l::acs::protocols::most::CMOSTEnum& DMBStatusDataType();
bool CurrentBrowserListLengthValue( uint8_t value );
uint8_t CurrentBrowserListLengthValue() const;
::k2l::acs::protocols::most::CMOSTUnsignedByte& CurrentBrowserListLengthDataType();
bool UpdateShadows();
bool Error( ::k2l::acs::protocols::most::DeviceID_t targetDevice, uint32_t payloadLength, const uint8_t *payload );
bool Error( ::k2l::acs::protocols::most::DeviceID_t targetDevice, uint8_t errorCode, uint32_t errorInfoLength, const uint8_t *pErrorInfo );            
...
class CTPEGDataRequest
{
	CDMBTuner *m_pInstance;
public:
	explicit CTPEGDataRequest( CDMBTuner *pInstance );
	~CTPEGDataRequest(void);
...
bool BlockTypeValue( acs::generated::fblock::DMBTuner::CTPEGDataRequest::TBlockType value );
acs::generated::fblock::DMBTuner::CTPEGDataRequest::TBlockType BlockTypeValue() const;
...
bool TPEGDataValue( uint8_t * value, uint32_t length );
uint8_t * TPEGDataValue() const;
::k2l::acs::protocols::most::CMOSTStream& TPEGDataDataType();
uint32_t TPEGDataStreamLength() const;
...
class CDMBTuner: public ::k2l::acs::protocols::most::CFunctionBlockBase
{
private:
	CDMBTuner();
	CDMBTuner(CDMBTuner& toCopy);
public:
	enum
	{
		FBlockID = 0xA0 /* = 160 (decimal) */
	};

	CDMBTuner( ::k2l::acs::protocols::most::InstanceID_t instanceID );
	CDMBTuner( ::k2l::acs::protocols::most::FBlockID_t fblockID,
		k2l::acs::protocols::most::InstanceID_t instanceID );
	virtual ~CDMBTuner( void );
...
::k2l::acs::protocols::most::CMOSTFunctionClassSequenceProperty m_signalQualityFunction;
::k2l::acs::protocols::most::CMOSTUnsignedByte m_signalQualityDMBSignalQualityParameter;
::k2l::acs::protocols::most::CNumberSpecificationUnsignedByte m_signalQualityDMBSignalQualityParameterSpec;
::k2l::acs::protocols::most::CMOSTFunctionClassSequenceProperty m_tPEGStatusFunction;
::k2l::acs::protocols::most::CMOSTEnum m_tPEGStatusParameter;
::k2l::acs::protocols::most::CMOSTEnumSpecification m_tPEGStatusParameterSpec;
const static uint8_t m_tPEGStatusParameterSpecValues[3];
::k2l::acs::protocols::most::CMOSTFunctionClassSequenceProperty m_tPEGInfoFunction;
::k2l::acs::protocols::most::CMOSTString m_tPEGInfoRecevieDateParameter;
::k2l::acs::protocols::most::CMOSTStringSpecification m_tPEGInfoRecevieDateParameterSpec;
::k2l::acs::protocols::most::CMOSTString m_tPEGInfoRecevieTimeParameter;
::k2l::acs::protocols::most::CMOSTStringSpecification m_tPEGInfoRecevieTimeParameterSpec;
::k2l::acs::protocols::most::CMOSTString m_tPEGInfoRecevieTextParameter;
::k2l::acs::protocols::most::CMOSTStringSpecification m_tPEGInfoRecevieTextParameterSpec;
::k2l::acs::protocols::most::CMOSTRecord m_tPEGInfoTPEGInfoRecordFixParameter;
::k2l::acs::protocols::most::CMOSTRecord m_tPEGInfoTPEGInfoRecordIteratorParameter;
::k2l::acs::protocols::most::CMOSTList m_tPEGInfoParameter;
::k2l::acs::protocols::most::CMOSTFunctionClassSequenceProperty m_dMBStatusFunction;
::k2l::acs::protocols::most::CMOSTEnum m_dMBStatusParameter;
::k2l::acs::protocols::most::CMOSTEnumSpecification m_dMBStatusParameterSpec;
const static uint8_t m_dMBStatusParameterSpecValues[2];
::k2l::acs::protocols::most::CMOSTUnsignedByte m_dMBStatusCurrentBrowserListLengthParameter;
::k2l::acs::protocols::most::CNumberSpecificationUnsignedByte m_dMBStatusCurrentBrowserListLengthParameterSpec;
::k2l::acs::protocols::most::CMOSTFunctionClassSequenceMethod m_tPEGDataRequestFunction;
::k2l::acs::protocols::most::CMOSTUnsignedWord m_tPEGDataRequestSenderHandleParameter;
::k2l::acs::protocols::most::CMOSTUnsignedLong m_tPEGDataRequestBlockCounterParameter;
::k2l::acs::protocols::most::CMOSTEnum m_tPEGDataRequestBlockTypeParameter;
::k2l::acs::protocols::most::CMOSTEnumSpecification m_tPEGDataRequestBlockTypeParameterSpec;
const static uint8_t m_tPEGDataRequestBlockTypeParameterSpecValues[3];
::k2l::acs::protocols::most::CMOSTUnsignedWord m_tPEGDataRequestBlockSizeParameter;
::k2l::acs::protocols::most::CMOSTStream m_tPEGDataRequestTPEGDataParameter;
...
friend class CSignalQuality;
friend class CTPEGStatus;
friend class CTPEGInfo;
friend class CDMBStatus;
friend class CTPEGDataRequest;
...
#endif // __DHAVN_MOSTMANAGER_DMBTUNERFBLOCK_H_
/*=============================================================================
 * END OF FILE
 *=============================================================================*/
