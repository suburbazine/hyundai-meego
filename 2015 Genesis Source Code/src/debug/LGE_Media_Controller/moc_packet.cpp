...
#include "src/devicemanager/packet.h"
...
static const char qt_meta_stringdata_Packet[] = {
    "Packet\0\0HandleAboutToClose()\0bytes\0"
    "HandleBytesWritten(qint64)\0"
    "HandleReadChannelFinished()\0"
    "HandleDataReceived()\0"
};
...
void Packet::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->HandleAboutToClose(); break;
        case 1: _t->HandleBytesWritten((*reinterpret_cast< qint64(*)>(_a[1]))); break;
        case 2: _t->HandleReadChannelFinished(); break;
        case 3: _t->HandleDataReceived(); break;
        default: ;
        }
    }
}
