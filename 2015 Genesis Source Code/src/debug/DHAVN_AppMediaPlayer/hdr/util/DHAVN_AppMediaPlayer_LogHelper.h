...
//#define LOG() qDebug() << "[MP]" << metaObject()->className() << "::" << __func__
//#define WARNING() qWarning() << "[MP_1]" << metaObject()->className() << "::" << __func__
//#define CRITICAL() qCritical() << QDateTime::currentDateTime().toString("hh:mm:ss.zzz") << " [MP_0]" << metaObject()->className() << "::" << __func__
...
inline QString methodName(const std::string& prettyFunction)
{
    ...
    QString qstr = QString::fromStdString(prettyFunction.substr(begin,end) + "()");
...
#define MP_LOG LoggerEx::Instance()->setLogLevel(LoggerEx::PRIORITY_LOW) << " " <<  __METHOD_NAME__ << " "
#define MP_HIGH LoggerEx::Instance()->setLogLevel(LoggerEx::PRIORITY_HI) << QDateTime::currentDateTime().toString("hh:mm:ss.zzz") << " " <<  __METHOD_NAME__ << " "
#define MP_CRITICAL LoggerEx::Instance()->setLogLevel(LoggerEx::PRIORITY_CRITICAL) << QDateTime::currentDateTime().toString("hh:mm:ss.zzz") << " " <<  __METHOD_NAME__ << " "
