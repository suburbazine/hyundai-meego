...
static const char qt_meta_stringdata_MessageServer[] = {
    "MessageServer\0\0messageArrived(QString)\0"
    "connectionIncome()\0readData()\0"
    "removeSock()\0sendBroadcastMessage(QString)\0"
    "sendAgreed()\0sendBackAgreed()\0"
};
...
void MessageServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->messageArrived((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->connectionIncome(); break;
        case 2: _t->readData(); break;
        case 3: _t->removeSock(); break;
        case 4: _t->sendBroadcastMessage((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 5: _t->sendAgreed(); break;
        case 6: _t->sendBackAgreed(); break;
        default: ;
        }
    }
}
...
// SIGNAL 0
void MessageServer::messageArrived(const QString & _t1)
{
