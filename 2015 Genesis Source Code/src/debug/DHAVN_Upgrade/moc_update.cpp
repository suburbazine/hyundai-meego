...
static const char qt_meta_stringdata_Update[] = {
    "Update\0\0cannotProceedUpdate(QString)\0"
    "showUSBDetachDialog()\0exitApplication()\0"
    "setMode(int)\0"
};
...
void Update::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->cannotProceedUpdate((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->showUSBDetachDialog(); break;
...
const QMetaObject Update::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_Update,
...
// SIGNAL 0
void Update::cannotProceedUpdate(const QString & _t1)
{
...
// SIGNAL 1
void Update::showUSBDetachDialog()
{
    QMetaObject::activate(this, &staticMetaObject, 1, 0);
}

// SIGNAL 2
void Update::exitApplication()
{
    QMetaObject::activate(this, &staticMetaObject, 2, 0);
}

// SIGNAL 3
void Update::setMode(int _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
