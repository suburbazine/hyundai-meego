...
static const char qt_meta_stringdata_QCANControllerListener[] = {
    ...
    "receivedData\0onCAN_data_received(SQCanFrameList)\0"
    "onTimeFormateChange(int)\0"
    "onSettingsModechange(bool)\0onAccStatus(int)\0"
    "onTimePickerPopupStatus(bool)\0status\0"
    "sendReakScreenLockStatus(bool)\0"
    "sendCAN_HU_CLOCK_E_00()\0"
};
...
void QCANControllerListener::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->onCAN_data_received((*reinterpret_cast< const SQCanFrameList(*)>(_a[1]))); break;
        case 4: _t->onTimeFormateChange((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 5: _t->onSettingsModechange((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 6: _t->onAccStatus((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 7: _t->onTimePickerPopupStatus((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 8: _t->sendReakScreenLockStatus((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 9: _t->sendCAN_HU_CLOCK_E_00(); break;
        default: ;
        }
    }
}
