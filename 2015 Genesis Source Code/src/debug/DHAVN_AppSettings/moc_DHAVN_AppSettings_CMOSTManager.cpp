/****************************************************************************
** Meta object code from reading C++ file 'DHAVN_AppSettings_CMOSTManager.h'
**
...
#error "The header file 'DHAVN_AppSettings_CMOSTManager.h' doesn't include <QObject>."
...
void CMOSTManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->iboxVersionUpdated((*reinterpret_cast< const QStringList(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject CMOSTManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CMOSTManager,
...
// SIGNAL 0
void CMOSTManager::iboxVersionUpdated(const QStringList _t1)
{
