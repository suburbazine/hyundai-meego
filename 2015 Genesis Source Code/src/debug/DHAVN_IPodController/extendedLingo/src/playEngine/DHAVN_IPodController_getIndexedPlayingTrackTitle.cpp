...
CGetIndexedPlayingTrackTitle::CGetIndexedPlayingTrackTitle(int nIndex,
                                                                int nTransId,  bool isTidEnabled)
                                                        :       CIAPPacket(0x04,0x0020,nTransId, isTidEnabled), m_Index(nIndex)
{

}

QByteArray CGetIndexedPlayingTrackTitle::marshall()
{
        QByteArray command;
	int i = -1;
 //  qDebug() << "In CGetIndexedPlayingTrackTitle::marshall \n ";
...
void  CGetIndexedPlayingTrackTitle::unmarshall(QByteArray)
{
}
