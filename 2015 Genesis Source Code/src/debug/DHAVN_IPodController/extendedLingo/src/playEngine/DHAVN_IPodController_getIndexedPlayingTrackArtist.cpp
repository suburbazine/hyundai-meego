...
CGetIndexedPlayingTrackArtistName::CGetIndexedPlayingTrackArtistName(int nIndex,
                                                                int nTransId,  bool isTidEnabled)
                                                        :       CIAPPacket(0x04,0x0022,nTransId, isTidEnabled), m_Index(nIndex)
{

}

QByteArray CGetIndexedPlayingTrackArtistName::marshall()
{
        QByteArray command;
	int i = -1;
 //  qDebug() << "In CGetIndexedPlayingTrackArtistName::marshall \n ";
...
void  CGetIndexedPlayingTrackArtistName::unmarshall(QByteArray)
{
}
