#ifndef DHAVN_APPSTANDBY_CAN_DEF_H
#define DHAVN_APPSTANDBY_CAN_DEF_H
...
class ClockCANDef : public QObject
{
public:
   //! CAN ID
   enum S_CAN_ID_T
   {
      S_CID_HU_CLOCK_E_00 = 0x32,
      S_CID_CLOCK_HU_E_01 = 0xC7,
//      S_CID_HU_CLOCK_P_01 = 0x509,
      S_CID_HU_CLOCK_P_01 = 0x11F // Update CanDB 12.03.03v // 0x509,
   };
...
#endif // DHAVN_APPSTANDBY_CAN_DEF_H
